...
class Shuffler_THREE_OF_A_KIND implements Shuffler
{
    public void shuffle(List<Card> cardList)
    {
        ...
        cardIndex= cardList.indexOf(new Card(Card.Rank.TWO, Card.Suit.HEARTS));
        Collections.swap(cardList, 1, cardIndex);
        cardIndex= cardList.indexOf(new Card(Card.Rank.TWO, Card.Suit.SPADES));
        Collections.swap(cardList, 2, cardIndex);
        cardIndex= cardList.indexOf(new Card(Card.Rank.FIVE, Card.Suit.HEARTS));
