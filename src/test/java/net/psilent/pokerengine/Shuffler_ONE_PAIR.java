...
class Shuffler_ONE_PAIR implements Shuffler
{
    public void shuffle(List<Card> cardList)
    {
        ...
        cardIndex= cardList.indexOf(new Card(Card.Rank.EIGHT, Card.Suit.HEARTS));
        Collections.swap(cardList, 1, cardIndex);
        cardIndex= cardList.indexOf(new Card(Card.Rank.FOUR, Card.Suit.SPADES));
        Collections.swap(cardList, 2, cardIndex);
        cardIndex= cardList.indexOf(new Card(Card.Rank.JACK, Card.Suit.HEARTS));
