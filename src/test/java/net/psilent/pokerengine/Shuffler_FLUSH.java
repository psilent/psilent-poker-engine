...
class Shuffler_FLUSH implements Shuffler
{
    public void shuffle(List<Card> cardList)
    {
        ...
        cardIndex= cardList.indexOf(new Card(Card.Rank.SEVEN, Card.Suit.CLUBS));
        Collections.swap(cardList, 2, cardIndex);
        cardIndex= cardList.indexOf(new Card(Card.Rank.NINE, Card.Suit.CLUBS));
