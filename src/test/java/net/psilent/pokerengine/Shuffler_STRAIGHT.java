...
class Shuffler_STRAIGHT implements Shuffler
{
    public void shuffle(List<Card> cardList)
    {
        ...
        cardIndex= cardList.indexOf(new Card(Card.Rank.THREE, Card.Suit.DIAMONDS));
        Collections.swap(cardList, 1, cardIndex);
        cardIndex= cardList.indexOf(new Card(Card.Rank.FOUR, Card.Suit.DIAMONDS));
